...
onready var calendar_node 	: Object	= load("res://data/asset scenes/calendar_node.tscn")
onready var header_node 	: Object	= load("res://data/asset scenes/header_node.tscn")
